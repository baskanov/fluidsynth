...
extern const fluid_real_t fluid_cb2amp_tab[];
extern const fluid_real_t fluid_ct2hz_tab[];
extern const fluid_real_t fluid_concave_tab[];
extern const fluid_real_t fluid_convex_tab[];
extern const fluid_real_t fluid_pan_tab[];
